 ...
 * that listener will be notified when setup is complete, after which (and not
 * before)
...
public class IabHelper {
     ...
     * must perform
     * setup by calling {@link #startSetup} and wait for setup to complete. This
     ...
     *                        find your app's base64-encoded
     ...
     * asynchronously.
     * You will be notified through the listener when the setup process is
     * complete.
    ...
    public interface OnIabPurchaseFinishedListener {
         ...
         * was successful,
         * then the sku parameter specifies which item was purchased. If the
         * purchase failed,
         * the sku and extraData parameters may or may not be null, depending on
         * how far the purchase
         * process went.
         *
     ...
     * an in-app purchase,
     * which will involve bringing up the Google Play screen. The calling
     * activity will be paused while
     * the user interacts with Google Play, and the result will be delivered via
     * the activity's {@link android.app.Activity#onActivityResult} method, at
     * which point you must call
     * this object's {@link #handleActivityResult} method to continue the
     * purchase flow. This method
     ...
     *                    the purchase data
     *                    when the purchase completes. This extra data will be
     *                    permanently bound to that purchase
     ...
     * billing. If you
     * are calling {@link #launchPurchaseFlow}, then you must call this method
     * from your
     * Activity's {@link android.app.Activity@onActivityResult} method. This
     * method
     * MUST be called from the UI thread of the Activity.
     *
     ...
     * handled;
     * false if the result was not related to a purchase, in which case
     * you should
     * handle it normally.
     */
     ...
     * asynchronously
     * and call back the specified listener upon completion. This method is safe
     * to
     ...
     * it.
     * This method may block or take long to return. Do not call from the UI
     * thread.
     ...
     * but
     * performs the consumption in the background and notifies completion
     * through
