...
public class RobotoCalendarView extends LinearLayout {
    ...
    private void clearDayOfTheMonthStyle(Date currentDate) {
        ...
        if (currentDate != null) {
            ...
            TextView textView = getDayOfMonthText(currentCalendar);
    ...
    public void markDayAsSelectedDay(Date currentDate) {
        ...
        TextView dayOfMonthBackground = getDayOfMonthText(currentCalendar);
        dayOfMonthBackground.setBackgroundResource(R.drawable.circle);
        dayOfMonthBackground.setTextColor(context.getResources().getColor(R.color.roboto_calendar_current_day_of_month));
    }
